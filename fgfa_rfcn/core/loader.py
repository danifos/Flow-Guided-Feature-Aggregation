...
class TestLoader(mx.io.DataIter):
    def __init__(self, roidb, config, batch_size=1, shuffle=False,
        ...
        self.data_name = ['data', 'im_info', 'aggregated_conv_feat_cache', 'data_cache', 'feat_cache']
    ...
    def get_batch(self):
        ...
        extend_data = [{'data': data[0]['data'] ,
                        ...
                        'aggregated_conv_feat_cache': data[0]['data'],
    ...
    def get_init_batch(self):
        ...
        extend_data = [{'data': data[0]['data'] ,
                        'im_info': data[0]['im_info'],
                        'aggregated_conv_feat_cache': np.zeros((1, 1024,
